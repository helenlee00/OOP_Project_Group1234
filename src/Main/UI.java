...
public class UI {
    ...
    public UI(GamePanel gp){
        ...
        try {
            InputStream is = getClass().getResourceAsStream("/font/CKFraternity.ttf");
...
//        gp.player.life = 3;
    ...
    public void drawTitleScreen()
    {
        if(titleScreenState == 0)
        {
            ...
            String text = "Christmas Treasure";
            int x = getXforCenterText(text);
            int y = gp.tileSize*3;
    
            //SHADOW OF TEXT
            g2.setColor(new Color(173, 216, 230)); // Màu xanh nhạt (Light Blue)

            g2.drawString(text, x + 5, y + 5);
    
            //MAIN COLOR
            g2.setColor(new Color(34, 139, 34)); // Xanh rừng
            ...
            g2.setColor(new Color(173, 216, 230)); // Light Blue (xanh nhạt như tuyết)
    ...
    public void drawCharacterScreen(){
     ...
     final int lineHeight = 32;             // độ giãn chữ trong bảng 


      //Names
      g2.drawString("Level 1", textX, textY);
      textY += lineHeight;
      ...
      textY+= lineHeight;
      g2.drawString("Denfense", textX, textY);
      textY+= lineHeight;
